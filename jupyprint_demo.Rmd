...
jupyprint("Testing with a mixed y vector, containing numbers AND latex strings...")
test_y_vector = np.append(y_vector[0:2], [3,4,5]).reshape(5, 1)
jupyprint(f"${arraytex(test_y_vector, contains_latex=True)} = {arraytex(design_matrix, contains_latex=True)} * {arraytex(beta_vector, contains_latex=True)}$")
